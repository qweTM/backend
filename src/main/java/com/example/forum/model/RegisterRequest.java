...
public class RegisterRequest {
  ...
  /**
   * Default constructor
   * @deprecated Use {@link RegisterRequest#RegisterRequest(String, String, String)}
   */
  @Deprecated
  ...
  */
  ...
  @Schema(name = "username", example = "john_doe", requiredMode = Schema.RequiredMode.REQUIRED)
